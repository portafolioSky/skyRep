--------------------------------------------------------
-- Archivo creado  - sábado-octubre-22-2016   
--------------------------------------------------------
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into AERONAVE (MATRICULA,MARCA,MODELO,FECHA_FABRICACION,HORAS_DE_VUELO,CERTIFICADO_DGAC,FECHA_VENCIMIENTO_DGAC,ESTADO_AERONAVE,ID_TIPO_AERONAVE,KMPORHORAS) values ('asder','asder','asder',to_date('01/01/16','DD/MM/RR'),'12',to_date('01/01/16','DD/MM/RR'),to_date('01/01/16','DD/MM/RR'),'FUERA DE VUELO','1','500');
...
OPEN p_recordset FOR
SELECT 
comp.ID_COMPONENTE as "Id Componente",
...
OPEN p_recordset FOR
SELECT
mant.ID_COMPONENTE as "Id Componente",
...
WHERE mant.ID_COMPONENTE like id_comp_var
