--------------------------------------------------------
-- Archivo creado  - martes-octubre-18-2016   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "LICENCIA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into USUARIO (RUT,NOMBRE,AP_PATERNO,AP_MATERENO,USUARIO,PASS,CORREO,ROL_ID_ROL,FECHA_MEDICINA_AEROESPACIAL,ESTADO) values ('17594659-4','Julio','Avendaño','Quezada','javendaño','javendaño','javendaño@vuelos.com','3',to_date('21/10/16','DD/MM/RR'),'ACTIVO');
...
Insert into USUARIO (RUT,NOMBRE,AP_PATERNO,AP_MATERENO,USUARIO,PASS,CORREO,ROL_ID_ROL,FECHA_MEDICINA_AEROESPACIAL,ESTADO) values ('19206741-3','Maria','Cardenas','Lepio','mcardenas','mcardenas','mcardenas@vuelos.com','3',to_date('10/10/16','DD/MM/RR'),'ACTIVO');
...
Insert into USUARIO (RUT,NOMBRE,AP_PATERNO,AP_MATERENO,USUARIO,PASS,CORREO,ROL_ID_ROL,FECHA_MEDICINA_AEROESPACIAL,ESTADO) values ('17789798-0','Guillermo','zuñiga','zuñiga','gzuniga','gzuniga','gzuniga@gmail.com','3',null,'DESACTIVADO');
...
WHERE RUT = P_rut;
IF res = 0 THEN
INSERT INTO usuario (rut,nombre,ap_paterno,ap_matereno,usuario,pass,correo,rol_id_rol,FECHA_MEDICINA_AEROESPACIAL) 
VALUES (P_rut,P_nombre, P_ap_paterno, P_ap_materno,P_user, P_pass, P_correo,3,P_vencMedicina);
COMMIT;
